...
const styles = StyleSheet.create({
  ...
  avatarInitial: { color: "#185b35", fontSize: 24, fontWeight: "900" },
  personCopy: { flex: 1, gap: 1 },
  personEyebrow: { color: "#718096", fontSize: 11, fontWeight: "800", textTransform: "uppercase" },
  personName: { color: "#172b22", fontSize: 20, fontWeight: "800" },
  bio: { color: "#53645c", fontSize: 13, lineHeight: 18 },
  cultures: { marginTop: 2, color: "#6a4d88", fontSize: 12, fontWeight: "600" },
