...
export default function MarketplaceDetailsScreen() {
  ...
  const claim = async () => {
    ...
    try {
      ...
      Alert.alert(
        "Food collected",
        "This giveaway is now saved under My collections.",
      );
    } catch (caught) {
      const message =
    ...
    <ScrollView contentContainerStyle={styles.content} style={styles.screen}>
      ...
      <View style={styles.body}>
        <Text style={styles.eyebrow}>
          {isCollected ? "YOUR COLLECTION" : "AVAILABLE IN KAI POOL"}
        </Text>
        <Text style={styles.title}>{listing.name}</Text>
        <Text style={styles.quantity}>
          {listing.quantity || "Quantity not specified"}
        </Text>
        ...
        {isCollected ? (
          <View style={styles.claimedNotice}>
            ...
            <Text style={styles.claimedText}>
              This food is unavailable to everyone else and saved in My
              collections.
            </Text>
          </View>
        ) : (
          ...
          >
            {claiming ? (
              ...
              <Text style={styles.claimButtonText}>Collect this food</Text>
            )}
          </Pressable>
        )}
      </View>
